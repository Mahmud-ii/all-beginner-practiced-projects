    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className='flex-1 flex flex-col justify-start mr-10'>
          ...
          <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Pariatur!</p>
        </div>
      ...
      <div className='w-full flex justify-between items-center md:flow-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45]'>
        <p className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'>
          2023 ipsum dolor sit amet consectetur.
        </p>
